...
document.addEventListener("DOMContentLoaded", function () {
  ...
  dlList.forEach((dl) => {
    const allProperties = Array.from(
      dl.querySelectorAll(".property[data-term]"),
    );
    ...
    allProperties.forEach((prop) => {
      ...
      const isIndexation = indexationPrefixes.some((prefix) =>
    ...
    if (propsIndexation.length > 0) {
      ...
      const minusSvg =
        '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line></svg>';
